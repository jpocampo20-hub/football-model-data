...
FBref las publica gratis y sin login, así que el costo es cero, a cambio
...
# (cualquier token final de 2-3 letras minusculas) -- si algun nombre de
# equipo real terminara en un token asi por coincidencia, revisar a mano
# el CSV de salida.
...
#                      marcador de los 90+30 min, NO el de penales, para
#                      no contaminar el ajuste de Poisson con goles de
#                      tanda de penales)
